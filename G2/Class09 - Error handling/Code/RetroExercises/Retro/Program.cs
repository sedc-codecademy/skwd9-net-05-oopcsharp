...
namespace Retro
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Person Stefan = new Person("Stefan", "Stefanoski", 28);
            ...
            Maria.FavouriteSongs = Songs.Where(x => x.Length > 360).ToList();
            ...
            Stefan.FavouriteSongs = Songs.Where(x => x.Length < 180 && x.Genre == Genre.Hip_hop).ToList();
