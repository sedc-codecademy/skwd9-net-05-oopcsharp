...
```
## Overriding methods
C# classes that inherit from other classes have pretty cool features. They can override the methods that belong to their parents. As long as their parent classes have a method that is open for overriding, they can override it and change the implementation.
## Overriding methods
```csharp
public class Human
{
