using AcademyAppDomain.Classes;
...
namespace AcademyApp
{
    class Program
    {
        ...
        private static void PopulateDatabase()
        {
            ...
            Admins.Add(new Admin("admin", "admin", "admin", 30));

            Trainers = new List<Trainer>();
            Trainers.Add(new Trainer("John123", "John", "Doe", 25));
            Trainers.Add(new Trainer("Bob123", "Boob", "Bobsky", 35));

            
            
            Students = new List<Student>();
            Students.Add(new Student("jane123", "Jane", "Doe", 21)
            {
                CurrentSubject = Subjects.First()
            });
            Students.First().Grades = new Dictionary<Subject, int>();
