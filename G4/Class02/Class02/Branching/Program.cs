...
namespace Branching
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (ifSuccess)
            {
                treeApples = trees * branchesOnTree * apllesOnBranch;
                
                if(treeApples % applesInBasket == 0)
                {
                    resultBaskets = treeApples / applesInBasket;
                } 
                else
                {
                    resultBaskets = (treeApples / applesInBasket) + 1;
                }
